...
slider.addImage("images/image1.jpg", "Photo d'une carte avec icones", "1 - Cliquez sur l'icone d'une station pour choisir l'endroit de votre reservation.");
...
slider.addImage("images/image4.jpg", "image d'une reservation", "4 - Vous avez maintenant une reservation durant 20 minutes.");
slider.shiftImage();
slider.animButton();
slider.animKeyboard();
